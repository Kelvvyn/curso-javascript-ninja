...
var teams = ['Flamengo','Corinthias','Fluminense','Botafogo','Sport'];
...
function convertToHex(cor){
  switch(cor){
      case 'vermelho':
    return console.log('#FF0000');
    break;
       case 'azul':
    return console.log('##0011ff');
    break;
      case 'rosa':
    return console.log('#ff00ce');
    break;
       case 'amarelo':
    return console.log('#fdff00');
    break;
      case 'preto':
    return console.log('#000');
    break;
     default:
